...
class CustomMarker {
  ...
  BitmapDescriptor getMarkerIcon({bool isSelected = false}) {
    ...
    return _selectedIcon != null
        ? BitmapDescriptor.bytes(_selectedIcon)
        : _getUnSelectedIcon();
  }

  BitmapDescriptor _getUnSelectedIcon() {
    return _unSelectedIcon != null
        ? BitmapDescriptor.bytes(_unSelectedIcon)
        : _defaultIcon;
  }
  ...
  CustomMarker copyWith({
    ...
    return CustomMarker(
      ...
      customInfoWindowWidth:
          customInfoWindowWidth ?? this.customInfoWindowWidth,
      customInfoWindowHeight:
          customInfoWindowHeight ?? this.customInfoWindowHeight,
