...
class CustomMapState extends State<CustomMap> {
  ...
  Widget build(BuildContext context) {
    ...
    final showDistanceWindow =
        context.watch<CustomMapModel>().showDistanceWindow;
    final infoWindowLeftMargin =
        context.watch<CustomMapModel>().infoWindowLeftMargin;
    final infoWindowTopMargin =
        context.watch<CustomMapModel>().infoWindowTopMargin;
  ...
  void _unSelectCurrentMarker() {
    ...
    if (lastSelectedMarkerIndex != null) {
      ...
      if (marker.hasSelectedIcon) {
        customMapModel.addMarker(false, false, marker, lastSelectedMarkerIndex,
            marker.getMarkerIcon(isSelected: false), onMarkerTap);
      }
    }
  ...
  void _initializeMarkers() {
    for (int index = 0; index < widget.markers.length; index++) {
      ...
      customMapModel.addMarker(false, true, marker, index, icon, onMarkerTap,
          notify: false);
    }
  }
  ...
  _changeInfoWindowAndMarker({
    ...
    customMapModel.addMarker(isMyLocationInfoWindow, false, customMarker,
        windowId, icon, onMarkerTap);
    ...
    if (!isMyLocationInfoWindow &&
      ...
      customMapModel.addMarker(true, false, widget.myLocationMarker!,
          myLocationInfoWindowIndex, icon, onMarkerTap);
    }
  ...
  void _updateMyLocationMarker() {
    ...
    customMapModel.addMarker(true, !_initialMyLocationMarkerSet,
        widget.myLocationMarker!, myLocationInfoWindowIndex, icon, onMarkerTap);
